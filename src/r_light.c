                 ...
                 float r, float g, float b)
{
    ...
    const float halo_a  = halo_a_next;
    halo_next = 1.0f;
    halo_dz_next = 0.0f;
    halo_a_next = 0.0f;
